	...
	render() {
		...
		const header = (
			<>
				...
				<span className="titan-management-nav__foldable-card-main-text">
			...
			<div className="titan-management-nav">
				...
				>
					<ul className="titan-management-nav__foldable-card-services">
						<li><a href="https://wp.titan.email/mail/" target="_blank" rel="noreferrer noopener"><img src={ titanMailIcon } alt={ translate( 'Titan Mail icon' ) } /><strong>{ translate( 'Mail' ) }</strong></a></li>
						<li><a href="https://wp.titan.email/calendar/" target="_blank" rel="noreferrer noopener"><img src={ titanCalendarIcon } alt={ translate( 'Titan Calendar icon' ) } /><strong>{ translate( 'Calendar' ) }</strong></a></li>
						<li><a href="https://wp.titan.email/contacts/" target="_blank" rel="noreferrer noopener"><img src={ titanContactsIcon } alt={ translate( 'Titan Contacts icon' ) } /><strong>{ translate( 'Contacts' ) }</strong></a></li>
					</ul>
				</FoldableCard>
