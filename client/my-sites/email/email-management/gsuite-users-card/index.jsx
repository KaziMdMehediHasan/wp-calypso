...
import { getGoogleAdminUrl, getGmailUrl, getGoogleCalendarUrl, hasPendingGSuiteUsers } from 'calypso/lib/gsuite';
	...
	renderDomainWithGSuite( domainName, users ) {
		...
		const header = (
			<>
				...
				<span className="gsuite-users-card__foldable-card-main-text">
			...
			<div key={ `google-apps-user-${ domainName }` }>
				...
				>
					<ul className="gsuite-users-card__foldable-card-services">
						<li><a href={ getGmailUrl( domainName ) } target="_blank" rel="noreferrer noopener"><img src={ gmailIcon } alt={ translate( 'Gmail icon' ) } /><strong>Gmail</strong></a></li>
						<li><a href={ getGoogleAdminUrl( domainName ) } target="_blank" rel="noreferrer noopener"><img src={ googleAdminIcon } alt={ translate( 'Google Admin icon' ) } /><strong>Admin</strong></a></li>
						<li><a href={ getGoogleCalendarUrl( domainName ) } target="_blank" rel="noreferrer noopener"><img src={ googleCalendarIcon } alt={ translate( 'Google Calendar icon' ) } /><strong>Calendar</strong></a></li>
					</ul>
				</FoldableCard>
